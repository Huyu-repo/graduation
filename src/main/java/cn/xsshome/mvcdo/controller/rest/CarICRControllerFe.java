...
@Controller
@RequestMapping(value="rest/caricr")
@Scope("prototype")
public class CarICRControllerFe {
    ...
    public JSONObject uploadImageClassify(@RequestParam(value = "file") MultipartFile file, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String httpUrl = "https://aip.baidubce.com/rest/2.0/image-classify/v1/car?access_token=" + bdicrService.getAuth();
        ...
        logger.info("=====carICR接口返回的内容:"+result);
...
//        result1.setProbability(jsonResult1.get("score")+"");
        result1.setName(jsonResult1.get("name")+"");
        result1.setScore(jsonResult1.get("score")+"");
        result1.setYear(jsonResult1.get("year")+"");
//        result1.setLocation();
        list.add(result1);
        ...
        logger.info("jsonResult1.get(\"year\")=========="+jsonResult1.get("year"));
