...
@Controller
@RequestMapping(value="rest/planticr")
@Scope("prototype")
public class PlantICRControllerFe {
    ...
    public JSONObject uploadImageClassify(@RequestParam(value = "file") MultipartFile file, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String httpUrl = "https://aip.baidubce.com/rest/2.0/image-classify/v1/plant?access_token=" + bdicrService.getAuth();
        ...
        logger.info("=====plantICR接口返回的内容:"+result);
