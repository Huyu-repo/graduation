...
import cn.xsshome.mvcdo.service.ai.baidu.impl.BDOCRServiceImpl;
...
public class PictureUtil {
    @Autowired
    private static BDOCRService bdocrService=new BDOCRServiceImpl();
    ...
    public static String request(String httpUrl, String httpArg) {
        ...
        try {
            ...
            connection.setRequestProperty("access_token", bdocrService.getAuth());
    ...
    public void resultReturn(){
        ...
        String httpUrl = "https://aip.baidubce.com/rest/2.0/ocr/v1/idcard?access_token=" + bdocrService.getAuth();
