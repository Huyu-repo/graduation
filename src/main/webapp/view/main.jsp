...
<head>
    ...
    <meta name="description" content="糊鱼">
...
<div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li><a href="#"> <i class="fa fa-home"></i>
                    <span class="nav-label">可视化</span> <span class="fa arrow"></span>
                </a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a id="index001" class="J_menuItem" href="index_v1.html">可视化</a>
                        </li>
                    </ul>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation"
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="hidden-xs"><a onclick="personal()" href="javascript:void();"><i
                            class="fa fa-id-card"></i> 个人</a></li>
        ...
        <div class="row content-tabs">
            ...
            <a href="<%=basePath%>jlpay/loginout" class="roll-nav roll-right J_tabExit"><i
                    class="fa fa fa-sign-out"></i> 退出</a>
        </div>
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<%=basePath%>view/chart.jsp"
