        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="site-heading">
                    <h1>菜品识别<span><img src="${ctx}/image/blog/wcsqrcode.jpg" title="糊鱼图像识别专属码"
                                       style="width:140px;"/></span></h1>
                    <span class="subheading">分析菜品信息，卡路里估测 更多体验 微信扫描上图小程序专属码</span>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function faceUp() {
        ...
        var option = {
            url: "${ctx}/rest/dishicr/detect",//url
            type: "POST",//方法类型
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.result.length; i++) {
                    griddata += "<tr>" + "<td>相似度</td>"+"<td>"+data.result[i].probability+"</td>"+"<td>卡路里</td>"+"<td>"+data.result[i].calorie+"</td>"+"<td>名称</td>"+"<td>"+data.result[i].name+"</td>"+"</tr>";
                }
