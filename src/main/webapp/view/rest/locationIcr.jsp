        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="site-heading">
                    <h1>地标识别<span><img src="${ctx}/image/blog/wcsqrcode.jpg" title="糊鱼图像识别专属码"
                                       style="width:140px;"/></span></h1>
                    <span class="subheading">分析地标信息，所属位置等属性 更多体验 微信扫描上图小程序专属码</span>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function faceUp() {
        ...
        var option = {
            url: "${ctx}/rest/locationicr/detect",//url
            type: "POST",//方法类型
            dataType: "json",//预期服务器返回的数据类型
            success: function (data) {
                console.log(data);
                var griddata = "<table class='data-view-table'>";
                    griddata += "<tr>" + "<td>" +"地标名"+"</td>"+"<td>"+data.result.landmark + "</td>" + "</tr>";
