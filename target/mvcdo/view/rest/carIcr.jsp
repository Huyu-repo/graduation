        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="site-heading">
                    <h1>车型识别<span><img src="${ctx}/image/blog/wcsqrcode.jpg" title="糊鱼图像识别专属码"
                                       style="width:140px;"/></span></h1>
                    <span class="subheading">分析车型信息，所属品牌等属性 更多体验 微信扫描上图小程序专属码</span>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function faceUp() {
        ...
        var option = {
            url: "${ctx}/rest/caricr/detect",//url
            type: "POST",//方法类型
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.result.length; i++) {
                    griddata += "<tr>" +"<td>"+"相似度"+"</td>"+"<td>" +data.result[i].score+"</td>" +"<td>"+"车名"+"</td>"+"<td>"+data.result[i].name+"</td>"+"<td>"+"生产年份"+"</td>"+"<td>"+data.result[i].year+"</td>"+"</tr>";
                }
