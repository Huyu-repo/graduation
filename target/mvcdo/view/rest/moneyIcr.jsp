        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="site-heading">
                    <h1>货币识别<span><img src="${ctx}/image/blog/wcsqrcode.jpg" title="糊鱼图像识别专属码"
                                       style="width:140px;"/></span></h1>
                    <span class="subheading">分析货币信息，所属年份 纸张份额 更多体验 微信扫描上图小程序专属码</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="clear-float">
                    <div class="data-view-container">
                        <div class="data-view" data-label="识别图片" id="demo-result">
                            <div class="canvas-container has-result">
                                <canvas width="592" height="400" data-scale="0.9932432432432432"
                                        style="position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%) scale(0.993243);">
                                    您的浏览器暂时不支持canvas，请选用现代浏览器！
                                </canvas>
                            </div>
...
<script type="text/javascript">
    function faceUp() {
        ...
        var option = {
            url: "${ctx}/rest/moneyicr/detect",//url
            type: "POST",//方法类型
            dataType: "json",//预期服务器返回的数据类型
            success: function (data) {
                console.log(data);
                var griddata = "<table class='data-view-table'>";
                    griddata += "<tr>" + "<td>货币名</td>"+"<td>"+data.result.currencyName+"</td>"+"<td>货币代码</td>"+"<td>"+data.result.currencyCode+"</td>"+"<td>年份</td>"+"<td>"+data.result.year+"</td>"+"<td>面额</td>"+"<td>"+data.result.currencyDenomination+"</td>"+"</tr>";
